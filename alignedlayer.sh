...
EOF
cd $HOME
curl -Ls https://snap.vnbnode.com/alignedlayer/genesis.json > $HOME/.alignedlayer/config/genesis.json
curl -Ls https://snap.vnbnode.com/alignedlayer/addrbook.json > $HOME/.alignedlayer/config/addrbook.json
sed -i \
